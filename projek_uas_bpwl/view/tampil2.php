...
<html lang="en">
<head>
  	<title>Tampilan Table User</title>
    <meta charset="utf-8">
  ...
  <div class="wrapper d-flex align-items-stretch">
        ...
        <ul class="list-unstyled components mb-5">
          <li class="active">
            <a href="tampil2.php"><span class="fa fa-home mr-3"></span> Home</a>
          </li>
          <li>
...
<footer>
  <p align="center">Jakarta International Soekarno-Hatta Airport</p>
  <p align="center">Address : PO.BOX 1245 BUSH, Jakarta, 19101, Kab. Tangerang, Banten,</p>
  <p align="center">Phone : +62 21 550 6823   |   Email : <a href="mailto:webmaster@angkasapura2.co.id"> webmaster@angkasapura2.co.id</p>
</footer>
