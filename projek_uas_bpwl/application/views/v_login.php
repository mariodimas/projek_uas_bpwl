...
<div class="container mx-auto h-full flex flex-1 justify-center items-center" >
  <div class="w-full max-w-lg">
    <div class="leading-loose">
      <form class="max-w-xl m-4 p-10 bg-white rounded shadow-xl" id="sign_in" method="POST" action="<?php echo base_url('login/aksi_login'); ?>">
        <p class="text-gray-800 font-medium text-center text-lg font-bold">Login Page</p>
        <div class="">
        ...
        <div class="mt-4 items-center justify-between">
          ...
          <br>
          <a class="inline-block right-0 align-baseline  font-bold text-sm text-500 hover:text-blue-800" href="<?php echo base_url('login/forgot'); ?>">
            Forgot Password?
          </a>
        </div>
