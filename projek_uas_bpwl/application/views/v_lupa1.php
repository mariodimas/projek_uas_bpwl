  ...
  <div class="w-full max-w-lg">
    <div class="leading-loose">
      <form class="max-w-xl m-4 p-10 bg-white rounded shadow-xl" id="forgot_password" method="POST">
        ...
        <p class="text-gray-800 font-medium text-center text-lg font-bold">Input username that you remember</p>
        <div class="">
        ...
        <div class="mt-4 items-center justify-between">
          <button class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded" name="submit-step-one" type="submit">Submit</button>
          <br>
        </div>
